...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self._root.setStyleSheet(
            "QWidget#homeRoot { background-color: transparent; }"
    ...
    def _apply_background(self, image_path: str | None) -> None:
        ...
        if image_path:
            ...
            # TODO: 在此处传入背景图路径，例如 self._apply_background("assets/bg.jpg")
            pass
